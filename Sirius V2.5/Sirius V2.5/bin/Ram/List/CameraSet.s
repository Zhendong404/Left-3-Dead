...
//  175 
//  176 /*
//  177 //OV7725摄像头寄存器初始化 成功返回1 失败返回0
...
//  240 
//  241 
//  242 //OV7620摄像头寄存器初始化 成功返回1 失败返回0
...
??CameraRegInit_0:
        ...
        BL       CameraDelay
//  261     
//  262     //PCLK四分频，HSYNC无效，CHSYNC无效，VSYNC有效边沿。
...
//  268     }
//  269     
//  270     //AWB激活阈值选择为 低， QVGA输出选择320*240，VSYNC在奇偶场均输出，HREF正极性，RGB伽马校正开启。
...
CameraInit:
        PUSH     {R7,LR}
//  299   
//  300     if(!CameraRegInit()) return 0; //摄像头寄存器初始化若失败，直接返回0
        BL       CameraRegInit
        CMP      R0,#+0
        BNE.N    ??CameraInit_0
        MOVS     R0,#+0
        B.N      ??CameraInit_1
//  301     CameraPortInit();              //摄像头所需端口配置
??CameraInit_0:
        BL       CameraPortInit
//  302     return 1;
        MOVS     R0,#+1
