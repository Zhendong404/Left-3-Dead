...
//    Cpu mode     =  thumb                                                   /
//    Endian       =  little                                                  /
//    Source file  =  D:\IAR_TEST\Sirius\Sirius V2.3\src\Sources\C\Component_ /
//                    C\DMA.c                                                 /
//    Command line =  "D:\IAR_TEST\Sirius\Sirius                              /
//                    V2.3\src\Sources\C\Component_C\DMA.c" -D IAR -D         /
...
//                    -Ol --use_c++_inline                                    /
//    List file    =  D:\IAR_TEST\Sirius\Sirius V2.3\bin\Ram\List\DMA.s       /
//                                                                            /
//                                                                            /
///////////////////////////////////////////////////////////////////////////////
...
// D:\IAR_TEST\Sirius\Sirius V2.3\src\Sources\C\Component_C\DMA.c
//    1 //==============================================================================
//    2 //文件名称：DMA.c
...
//  112                                                     );
        UXTB     R0,R0            ;; ZeroExt  R0,R0,#+24,#+24
        LDR.N    R5,??DataTable0_2  ;; 0x40021000
        ANDS     R1,R1,#0x3F
        ORRS     R1,R1,#0x80
        STRB     R1,[R0, R5]
//  113     
//  114 	DMA_CR = 0;												  // 默认配置，需要在DMA被激活之前配置此寄存器
        LDR.N    R1,??DataTable0_3  ;; 0x40008000
        MOVS     R5,#+0
        STR      R5,[R1, #+0]
...
//  116 	DMA_BASE_PTR->TCD[DMA_CHn].CITER_ELINKNO = DMA_CITER_ELINKNO_CITER(DMA_Count); // 主循环计数器，1个major loop, 即一次传输量=major_loop*minor_loop，最大为2^15=32767 
        ...
        ADDS     R1,R1,#+36864
        LSLS     R5,R2,#+17       ;; ZeroExtS R5,R2,#+17,#+17
        LSRS     R5,R5,#+17
        STRH     R5,[R1, #+22]
