...
//    Command line =  "D:\IAR_TEST\Sirius\Sirius V2.3\src\Sources\C\isr.c"    /
...
//                    -Ol --use_c++_inline                                    /
//    List file    =  D:\IAR_TEST\Sirius\Sirius V2.3\bin\Ram\List\isr.s       /
//                                                                            /
//                                                                            /
///////////////////////////////////////////////////////////////////////////////
...
PORTA_Isr:
        PUSH     {R7,LR}
//   68     PORTA_ISFR = ~0;
        LDR.N    R0,??DataTable7_6  ;; 0x400490a0
        MOVS     R1,#-1
        STR      R1,[R0, #+0]
...
PORTB_Isr:
        PUSH     {R7,LR}
//   77     PORTB_ISFR = ~0;
        LDR.N    R0,??DataTable7_8  ;; 0x4004a0a0
        MOVS     R1,#-1
        STR      R1,[R0, #+0]
...
//   86     PORTC_ISFR =  ~0;             //清除PORTC的所有中断标志位
        LDR.N    R1,??DataTable7_10  ;; 0x4004b0a0
        MOVS     R2,#-1
        STR      R2,[R1, #+0]
//   87     
...
//  100     PORTD_ISFR =  ~0;             //清除PORTD的所有中断标志位
        LDR.N    R1,??DataTable7_11  ;; 0x4004c0a0
        MOVS     R2,#-1
        STR      R2,[R1, #+0]
//  101     
...
PORTE_Isr:
        PUSH     {R7,LR}
//  115     PORTE_ISFR = ~0;
        LDR.N    R0,??DataTable7_12  ;; 0x4004d0a0
        MOVS     R1,#-1
        STR      R1,[R0, #+0]
