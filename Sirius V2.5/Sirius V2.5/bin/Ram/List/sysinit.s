///////////////////////////////////////////////////////////////////////////////
//                                                                            /
// IAR ANSI C/C++ Compiler V6.30.1.53127/W32 for ARM    13/Nov/2014  01:13:33 /
// Copyright 1999-2011 IAR Systems AB.                                        /
//                                                                            /
//    Cpu mode     =  thumb                                                   /
//    Endian       =  little                                                  /
//    Source file  =  D:\IAR_TEST\Sirius\Sirius V2.1\src\Sources\C\Frame_C\sy /
//                    sinit.c                                                 /
//    Command line =  "D:\IAR_TEST\Sirius\Sirius                              /
//                    V2.1\src\Sources\C\Frame_C\sysinit.c" -D IAR -D         /
...
//                    -Ol --use_c++_inline                                    /
//    List file    =  D:\IAR_TEST\Sirius\Sirius V2.1\bin\Ram\List\sysinit.s   /
//                                                                            /
//                                                                            /
///////////////////////////////////////////////////////////////////////////////
...
// D:\IAR_TEST\Sirius\Sirius V2.1\src\Sources\C\Frame_C\sysinit.c
//    1 //-------------------------------------------------------------------------*
//    2 // 文件名:sysinit.c                                                        *
//    3 // 说  明: 系统配置文件                                                    *
//    4 //-------------------------------------------------------------------------*
...
//   64     PORTA_PCR6 = ( PORT_PCR_MUX(0x7));
        LDR.N    R0,??DataTable4_6  ;; 0x40049018
        MOV      R1,#+1792
        STR      R1,[R0, #+0]
//   65 }
        BX       LR               ;; return
...
//   79     PORTC_PCR3 = ( PORT_PCR_MUX(0x5));
        LDR.N    R0,??DataTable4_8  ;; 0x4004b00c
        MOV      R1,#+1280
        STR      R1,[R0, #+0]
//   80 }
        BX       LR               ;; return
...
//  100              MCG_C2 = 0;
??pll_init_2:
        LDR.N    R2,??DataTable4_9  ;; 0x40064001
        MOVS     R3,#+0
        STRB     R3,[R2, #+0]
//  101     #else
//  102              //使能外部晶振
...
//  125     MCG_C5 = MCG_C5_PRDIV(0x18);
        LDR.N    R2,??DataTable4_14  ;; 0x40064004
        MOVS     R3,#+24
        STRB     R3,[R2, #+0]
//  126     #else
//  127     
...
//  133     MCG_C6 = 0x0;
        LDR.N    R2,??DataTable4_15  ;; 0x40064005
        MOVS     R3,#+0
        STRB     R3,[R2, #+0]
...
//  141       MCG_C6 = MCG_C6_PLLS_MASK | MCG_C6_VDIV(1); //VDIV = 1 (x25)
        LDR.N    R0,??DataTable4_15  ;; 0x40064005
        MOVS     R1,#+65
        STRB     R1,[R0, #+0]
//  142       pll_freq = 50;
        MOVS     R1,#+50
...
//  240   //首先移动到FBE模式
//  241   MCG_C2 = 0;  
        LDR.N    R0,??DataTable4_9  ;; 0x40064001
        MOVS     R1,#+0
        STRB     R1,[R0, #+0]
...
//  259   MCG_C5 = MCG_C5_PRDIV(0x11);                
        LDR.N    R0,??DataTable4_14  ;; 0x40064004
        MOVS     R1,#+17
        STRB     R1,[R0, #+0]
//  260     
...
//  274     | SIM_CLKDIV1_OUTDIV3(1) | SIM_CLKDIV1_OUTDIV4(7);       
        LDR.N    R1,??DataTable4_3  ;; 0x40048044
        LDR.N    R2,??DataTable4_17  ;; 0x1170000
        STR      R2,[R1, #+0]
//  275     
