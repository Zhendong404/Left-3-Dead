...
#define __VECTORS_H     1
    ...
    #define PORTE_IRQ 91
    //摄像头用的IRQ号宏定义
    #define FIELD_IRQ PORTD_IRQ 
    #define LINE_IRQ PORTC_IRQ
    #define PCLK_IRQ PORTB_IRQ
    ...
    #define VECTOR_016      DMA0_Isr        // 0x0000_0040 16     0     DMA              DMA Channel 0 transfer complete
    ...
    #define VECTOR_061      uart0_isr       // 0x0000_00F4 61    45     UART0            Single interrupt vector for UART status sources
    ...
    #define VECTOR_106      PORTD_Isr       // 0x0000_01A8 106   90     Port control module Pin Detect (Port D)
    #define VECTOR_107      PORTE_Isr       // 0x0000_01AC 107   91     Port control module Pin Detect (Port E)
