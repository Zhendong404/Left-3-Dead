...
uint8_t LandzoRAM[]={   //origin reg data
, 
};
...
u8 getCameraReg(void)
{
      ...
      for(i = 0 ; i < EROMCont ; )
      {
        Reg_buff[i] = LandzoRAM[i] ; 
      //  uart_putchar(UART0,IIClandzo_buff[i]);
        BFdelay_1us(10);      // 延时1us 
        LandzoOK = receiveNbyte(0XDD,&Reg_buff[i],1) ;
        if(!LandzoOK)
        {
            printf("Error in reading: i = %d\n", i);
            return 0;
        }
        i += 2;
      }
